...
CREATE TABLE IF NOT EXISTS inventory_entries (
    ...
    -- supplier info (for 'received' type) / source info (for 'opening')
...
CREATE TABLE IF NOT EXISTS order_items (
                                           ...
                                           price INTEGER NOT NULL,
                                           discount_price INTEGER NOT NULL,
                                           ck_percent REAL NOT NULL DEFAULT 0
);

-- =============================
-- MIGRATIONS (safe for existing DBs)
-- =============================
-- These will silently fail if columns already exist, which is fine for SQLite

-- inventory_entries new columns
CREATE TABLE IF NOT EXISTS _migration_tmp (x INTEGER);
DROP TABLE IF EXISTS _migration_tmp;
